    ...
    <KeyboardAvoidingView behavior={Platform.OS == "android" ? "padding" : "height"}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View className="my-1 w-full">
                ...
                <View className={`flex flex-row justify-start items-center relative bg-purple-100 rounded-full border-neutral-100 focus:border=primary-500 ${containerStyle}`}
                >
